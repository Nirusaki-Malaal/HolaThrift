  ...
  return (
    <section className="relative z-10 flex min-h-screen w-full items-center justify-center overflow-hidden px-4 text-center transform-gpu">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="mt-8 max-w-md md:max-w-xl text-sm md:text-base font-medium tracking-wide text-neutral-400">
          Strictly curated 1-of-1 vintage & streetwear.
          <br className="hidden md:block" />
          Once it's gone, it's gone forever.
        </p>

        <button className="relative group mt-10 md:mt-12 inline-flex items-center justify-center overflow-hidden rounded-full bg-white px-8 py-4 text-sm font-black uppercase tracking-wider text-black shadow-[0_0_40px_rgba(255,255,255,0.3)] transition-all duration-300 hover:bg-neutral-100 hover:shadow-[0_0_60px_rgba(255,255,255,0.7)] active:scale-95 transform-gpu cursor-pointer">
