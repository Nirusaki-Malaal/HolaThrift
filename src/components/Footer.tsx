...
export default function Footer({ setActivePage }: FooterProps): React.JSX.Element {
  return (
    <footer className="bg-[#0a0a0a] border-t border-white/5 pt-16 pb-8 mt-auto relative overflow-hidden w-full">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 text-left">
          <div>
            <div
              className="flex items-center space-x-2 mb-6 cursor-pointer inline-flex group"
          ...
          <div className="md:pl-12">
            <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-6">The Store</h4>
          ...
          <div>
            <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-6">Hit Us Up</h4>
